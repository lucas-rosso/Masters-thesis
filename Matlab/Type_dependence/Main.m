...
% Code including Type Dependence
% Author: Lucas Rosso %
% Date: 15-04-2021 %
...
mu    = 0.06; % Gomes and Michaelides (JF, 2005)   
sigma_diff    = optimal_params(3);                  

% diffusion with scale dependence
varthe = optimal_params(2);
...
fprintf('Made it !!')
% save('DATA_03022021') % to avoid going through the iteration again.
