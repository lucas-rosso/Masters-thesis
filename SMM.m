...
%% Loss function
% loss = [part_rate - 0.2681333; bottom50_share - 0.0065246]'*eye(2)*[part_rate - 0.2681333; bottom50_share - 0.0065246]
% table = {'Part. Rate', round(part_rate,3)*100, 26.8; 'Bottom 50%', round(bottom50_share,3)*100, 0.7}
